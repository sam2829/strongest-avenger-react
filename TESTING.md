...
| User cannot edit another's post. | A user is unable to edit the post of another users. | Went to the edit form of a specific post and user and copied the URL. Then logged in as a different user and tried pasting in that URL. | When I pasted URL in I was redirected to homepage and unable to edit another's post. |
...
| Profile image on comment link to profile page. | If a user clicks on the profile image on the comment, the user will be re-directed to that specific users profile page. | Clicked on many different profile images on comments. | Each time was re-directed to that specific users profile page. |
...
| Only see reports of the logged in user. | When the user loads the my reports page, the user should only be able to see their own reports and not of any other user. | Logged in as many different users and each time I was only able to view the reports of the user I was logged in as. | Pass |
...
| User redirected if trying to edit another useres report. | If a user tries to access the edit report form of another user via the URL link, the user will be redirected back to the homepage. | Pasted in the URL for the edit report form for a another user report. | Each time I was redirected to the homepage. | Pass |
